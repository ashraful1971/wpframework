    ...
    public function cache(?string $path = null)
    {
        ...
        File::put(
            ...
            "<?php \r\n\r\n/** Auto generated by discovering the listeners. Don't edit this file manually."
                . " */\r\n\r\nreturn "
                // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_var_export -- Generates a cached PHP file's return statement; this is var_export's documented use case, not debug output.
